...
@SuppressLint("UseValueOf") public class CoordinateConversion
{
  ...
  /**
   * Convert Latitude and Longitude to UTM data
   */
  ...
  /**
   * Convert Latitude and Longitude to MGRUTM
   */
  ...
  /**
   * Convert MGRUTM to Latitude and Longitude
   */
