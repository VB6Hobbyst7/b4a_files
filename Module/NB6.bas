...
Public Sub Build2 (ContentTitle As Object, ContentText As Object, Tag As String, Intent2 As Intent) As Notification
	If IsOld Then
		OldNotification.SetInfo2(ContentTitle, ContentText, Tag, Intent2)
		Return OldNotification
	Else
